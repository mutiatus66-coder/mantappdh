...
/* Card header */
[data-bs-theme="light"] .sub-card .card-header { background: #E5DFC5; border-bottom: 1px solid rgba(201, 168, 76, .25); }
[data-bs-theme="dark"]  .sub-card .card-header { background: #2A2C2B; border-bottom: 1px solid rgba(201, 168, 76, .20); }

/* Card body */
[data-bs-theme="light"] .sub-card .card-body { background: #E3E3E3; }
[data-bs-theme="dark"]  .sub-card .card-body { background: #374140; }

/* Card title */
[data-bs-theme="light"] .sub-card .card-title { color: #2A2C2B !important; }
[data-bs-theme="dark"]  .sub-card .card-title { color: #E3E3E3 !important; }
...
[data-bs-theme="light"] .se-table tbody td { color: #374140; border-bottom: 1px solid rgba(201, 168, 76, .12); }
[data-bs-theme="dark"]  .se-table tbody td { color: rgba(245, 240, 232, .82); border-bottom: 1px solid rgba(201, 168, 76, .08); }

[data-bs-theme="light"] .se-table tbody tr:hover td { background: rgba(201, 168, 76, .06); }
[data-bs-theme="dark"]  .se-table tbody tr:hover td { background: rgba(201, 168, 76, .05); }

[data-bs-theme="light"] .se-table .se-empty { color: #999; }
[data-bs-theme="dark"]  .se-table .se-empty { color: rgba(245, 240, 232, .35); }
...
[data-bs-theme="light"] .badge-kategori { background: rgba(201, 168, 76, .15); color: #374140; border: 1px solid rgba(201, 168, 76, .35); }
[data-bs-theme="dark"]  .badge-kategori { background: rgba(201, 168, 76, .14); color: #E3E3E3; border: 1px solid rgba(201, 168, 76, .30); }
...
.btn-gold      { border-radius: .375rem; padding: .35rem .85rem; font-size: .8rem; letter-spacing: .02em; }
.btn-tambah-se { border-radius: .5rem;   padding: .55rem 1.25rem; font-size: .9rem; box-shadow: 0 3px 12px rgba(201, 168, 76, .30); }
...
[data-bs-theme="light"] .modal-content { background: #FDFAF3; }
[data-bs-theme="dark"]  .modal-content { background: #E3E3E3; border: 1px solid rgba(201, 168, 76, .25); }

[data-bs-theme="dark"] .modal-header,
[data-bs-theme="dark"] .modal-footer    { border-color: rgba(201, 168, 76, .15) !important; }
[data-bs-theme="dark"] .modal-title     { color: #E8C96B; }
[data-bs-theme="dark"] .form-label      { color: rgba(245, 240, 232, .75); }
...
[data-bs-theme="dark"] .form-control::placeholder { color: rgba(245, 240, 232, .30) !important; }
[data-bs-theme="dark"] .form-select option         { background: #132146; color: #F5F0E8; }
...
[data-bs-theme="dark"] .btn-modal-cancel       { background: rgba(255, 255, 255, .07); color: rgba(245, 240, 232, .70); border: 1px solid rgba(255, 255, 255, .15); }
    ...
    <div class="col-12">
        ...
        <div class="card sub-card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center py-4 px-5">
                <h3 class="card-title fw-bold m-0">Data Sub Event</h3>
            </div>
                            ...
                            @forelse($subEvents as $item)
                                <tr>
                                    ...
                                    <td class="text-center pe-3">
                                        ...
                                        <button class="btn btn-gold btn-sm btn-edit me-1"
                                                data-id="{{ $item['id'] }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="number" name="tahun" id="tahun"
                                   class="form-control" placeholder="cth. 2025" required>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" name="sub_event" id="sub_event"
                                   class="form-control" placeholder="Nama sub event" required>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form     = document.getElementById('formSubEvent');
    ...
    document.querySelectorAll('.btn-edit').forEach(function (btn) {
        btn.addEventListener('click', async function () {
            ...
            const data = await fetch(`/sub-event/${id}/edit`).then(r => r.json());

            title.innerText                            = 'Edit Sub Event';
    ...
    document.querySelector('[data-bs-target="#modalSubEvent"]')
        .addEventListener('click', function () {
            title.innerText                             = 'Tambah Sub Event';
