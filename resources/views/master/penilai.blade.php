...
<!-- ============================================================
     Rumah Inovasi Magetan - Panel Admin | Halaman Penilai
     Tampilan mengikuti layout halaman Event (dengan Tailwind & Metronic)
     Data tabel sesuai screenshot: LOMBA INOTEK 2022
     ============================================================ -->
...
<head>
  ...
  <style>
    ...
    /* Untuk link hapus pada tabel penilai */
    .btn-penilai-hapus {
      color: #dc3545;
      text-decoration: none;
      font-weight: 500;
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
  ...
  <div class="d-flex flex-column flex-root">
    <div class="page d-flex flex-row flex-column-fluid">
      ...
      <!-- ============================================================
           SIDEBAR (ASIDE) — sama persis dengan halaman Event
           ============================================================ -->
      <div id="kt_aside"
        ...
        <div class="aside-menu flex-column-fluid" id="kt_aside_menu">
          <nav id="ri-sidebar-nav">
            ...
            <a class="ri-menu-item active" href="/master/penilai">
              <span class="ri-icon">
                <svg viewBox="0 0 24 24">
      ...
      <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
        ...
        <!-- CONTENT AREA (flex spacer) — di sini kita ganti dengan tabel Penilai -->
        <div id="kt_content" class="content d-flex flex-column flex-column-fluid">
          <div class="p-6">

            <!-- Tombir Tambah Penilai (mirip dengan tombol Tambah Event) -->
            ...
            <!-- CARD TABLE — data penilai sesuai screenshot -->
            <div class="items-center mb-4 mt-4 bg-white rounded-lg shadow border border-gray-200">
              <div class="p-4 overflow-x-auto">
                <div class="items-center mb-6 mt-4">
                  <h2 class="text-lg font-semibold text-blue-600">Sub Event : LOMBA INOTEK 2022</h2>
                  <p class="text-sm text-gray-500">Daftar Penilai</p>
                </div>
                <table class="w-full border border-gray-300">
                  <thead class="bg-gray-200 text-gray-600">
                    <tr>
                      <th class="px-4 py-3 w-16 text-center">No</th>
                      <th class="px-4 py-3 text-left">Nama Penilai</th>
                      <th class="px-4 py-3 text-left">Email</th>
                      <th class="px-4 py-3 w-32 text-center">Aksi</th>
                    </tr>
                  </thead>
                  <tbody class="text-gray-700">
                    <!-- Data persis dari screenshot -->
                    <tr class="border-t hover:bg-gray-50">
                      <td class="px-4 py-3 text-center">1</td>
                      <td class="px-4 py-3">muhammad noor majid</td>
                      <td class="px-4 py-3">m.noormajid12@gmail.com</td>
                      <td class="px-4 py-3 text-center">
                        <a href="#" class="btn-penilai-hapus">🔗 Hapus</a>
                      </td>
                    </tr>
                    <tr class="border-t hover:bg-gray-50">
                      <td class="px-4 py-3 text-center">2</td>
                      <td class="px-4 py-3">Moch Nurrudin</td>
                      <td class="px-4 py-3">moch.nurudin72@gmail.com</td>
                      <td class="px-4 py-3 text-center">
                        <a href="#" class="btn-penilai-hapus">🔗 Hapus</a>
                      </td>
                    </tr>
                    <tr class="border-t hover:bg-gray-50">
                      ...
                      <td class="px-4 py-3">Mujiono</td>
                      <td class="px-4 py-3">mujiono.aldifa@gmail.com</td>
                      <td class="px-4 py-3 text-center">
                        <a href="#" class="btn-penilai-hapus">🔗 Hapus</a>
                      </td>
                    </tr>
                    <tr class="border-t hover:bg-gray-50">
                      ...
                      <td class="px-4 py-3">Alam Surya</td>
                      <td class="px-4 py-3">alam.endriharto@gmail.com</td>
                      <td class="px-4 py-3 text-center">
                        <a href="#" class="btn-penilai-hapus">🔗 Hapus</a>
                      </td>
                    </tr>
                    <tr class="border-t hover:bg-gray-50">
                      ...
                      <td class="px-4 py-3">Eko Adri</td>
                      <td class="px-4 py-3">remingtonsteel320@yahoo.com</td>
                      <td class="px-4 py-3 text-center">
                        <a href="#" class="btn-penilai-hapus">🔗 Hapus</a>
                      </td>
                    </tr>
                    <tr class="border-t hover:bg-gray-50">
                      ...
                      <td class="px-4 py-3">Jatmiko</td>
                      <td class="px-4 py-3">okimfh99@gmail.com</td>
                      <td class="px-4 py-3 text-center">
                        <a href="#" class="btn-penilai-hapus">🔗 Hapus</a>
                      </td>
                    </tr>
  ...
  <!-- ============================================================
       DRAWERS (tetap ada, tidak diubah)
       ============================================================ -->
    ...
    <div class="card shadow-none border-0 rounded-0">
      ...
      <div class="card-body position-relative" id="kt_activities_body">
        <div id="kt_activities_scroll" class="position-relative scroll-y me-n5 pe-5"
          ...
          <!-- Timeline items kosong (optional) -->
        </div>
      </div>
  ...
  <!-- ============================================================
       JAVASCRIPT BUNDLES (sama persis dengan aslinya)
       ============================================================ -->
  ...
  <script>
    // Menandai menu aktif: Penilai (sudah diberi class active di atas, tapi untuk dinamis)
