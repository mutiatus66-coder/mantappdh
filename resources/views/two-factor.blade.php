...
<base href="../../../" />
	...
	<body id="kt_body" class="auth-bg">
						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100 mb-13" novalidate="novalidate" data-kt-redirect-url="index.html" id="kt_sing_in_two_factor_form">
								...
								<div class="text-center mb-10">
									<img alt="Logo" class="mh-125px" src="template.demo6/demo6/assets/media/svg/misc/smartphone-2.svg" />
								</div>
								<!--end::Icon-->
								<!--begin::Heading-->
								<div class="text-center mb-10">
		...
		<script src="template.demo6/demo6/assets/js/custom/authentication/sign-in/two-factor.js"></script>
