...
(async function runPesertaWorkflow() {
    ...
    try {
        ...
        await sleep(3000);
        await takeScreenshotSession(driver, 'peserta_Daftar');
        ...
        await sleep(1000);
        await takeScreenshotSession(driver, 'peserta_Tambah');
        ...
        await sleep(1000);
        await takeScreenshotSession(driver, 'peserta_Form_Step1');
        ...
        await pressButton('Selanjutnya');
        await sleep(1000);
        await takeScreenshotSession(driver, 'peserta_Form_Step2');
        ...
        await sleep(3000);
        await takeScreenshotSession(driver, 'peserta_Form_Step3_Simpan');
