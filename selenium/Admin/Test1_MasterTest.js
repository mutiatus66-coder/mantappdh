...
import { sleep, testDataTables, takeScreenshotSession, clearInput } from '../helpers.js';
...
(async function test1Master() {
    ...
    try {
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Event_Index');
        await testDataTables(driver, 'Event');
        await executeScriptClick('#btnTambahEvent');
        await sleep(800);
        await takeScreenshotSession(driver, 'Test1_Event_Tambah_Modal');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Event_Simpan');
        ...
        await executeScriptClick('#btnSimpanEvent');
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Event_Edit_Simpan');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_SubEvent_Simpan');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_SubEvent_Hapus');

        // 3. BIDANG
        console.log("   -> Bidang: Tambah, Hapus...");
        await executeScriptClick('a.ri-menu-item[href="/bidang"]');
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Bidang_Index');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Bidang_Simpan');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Bidang_Hapus');

        // 4. USER
        console.log("   -> User: Tambah, Hapus...");
        await executeScriptClick('a.ri-menu-item[href="/user"]');
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_User_Index');
        await testDataTables(driver, 'User');
        await executeScriptClick('#btnTambahUser');
        await sleep(800);
        await takeScreenshotSession(driver, 'Test1_User_Tambah_Modal');
        ...
        await sleep(2000);
        let userSearchInput = await driver.findElement(By.css('.dt-search input'));
        await clearInput(driver, userSearchInput);
        await userSearchInput.sendKeys('User Test');
        await sleep(1000);
        await driver.executeScript(`
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_User_Hapus');

        // 5. PENGUMUMAN
        console.log("   -> Pengumuman: Tambah, Hapus...");
        await executeScriptClick('a.ri-menu-item[href="/pengumuman"]');
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Pengumuman_Index');
        await testDataTables(driver, 'Pengumuman');
        await executeScriptClick('#btnTambahPengumuman');
        await sleep(800);
        await takeScreenshotSession(driver, 'Test1_Pengumuman_Tambah_Modal');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Pengumuman_Simpan');
        ...
        await sleep(2000);
        await takeScreenshotSession(driver, 'Test1_Pengumuman_Hapus');
