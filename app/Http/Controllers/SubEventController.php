...
class SubEventController extends Controller
{
    ...
    {
        return session('sub_events', self::DEFAULT_DATA);
    }
    ...
    private function buildRow(Request $request, int $id): array
    {
        return [
            'id'        => $id,
    ...
    public function store(Request $request)
    {
        ...
        $data   = $this->getData();
        $data[] = $this->buildRow($request, $this->nextId($data));
        $this->saveData($data);
