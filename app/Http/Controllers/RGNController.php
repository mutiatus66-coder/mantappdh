...
class RGNController extends Controller
{
    ...
    private static array $nominasi = [
        ...
        3 => [
            ...
            // Pelajar — tidak ada peserta tahun ini
        ],
    ...
    public function storeBidang(Request $request)   { /* TODO */ }
    public function editBidang(int $id)             { /* TODO */ }
    public function updateBidang(Request $request, int $id) { /* TODO */ }
    public function destroyBidang(int $id)          { /* TODO */ }

    // ── Penilaian — shared helper ─────────────────────────────────────────────
    ...
    public function penilaianTahap1Simpan(Request $request, int $id)
    {
        $request->validate([
